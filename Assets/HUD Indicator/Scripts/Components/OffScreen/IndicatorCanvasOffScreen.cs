...
namespace HUDIndicator {
	public class IndicatorCanvasOffScreen : IndicatorCanvas {
        ...
        private IndicatorRenderer newRenderer;
        private Indicator newIndicator;
        ...
        private void UpdatePosition() {
            Rect rendererRect = newRenderer.GetRect();
            Vector3 pos = newRenderer.GetRectTransform().InverseTransformPoint(newRenderer.camera.WorldToScreenPoint(newIndicator.gameObject.transform.position));
